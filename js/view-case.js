document.addEventListener('DOMContentLoaded', function () {
    ...
    // Função para gerar relatório (atualizada)
    async function generateReport() {
        ...
        // usando jsPDF como você já tinha
        ...
        doc.text(`Data: ${reportDate}`, 10, 40);
        
        doc.setFontSize(12);
        doc.text(`Constatações:`, 10, 60);
        doc.text(findings, 10, 70, { maxWidth: 180 });
        
        doc.text(`Conclusões:`, 10, 120);
        doc.text(conclusions, 10, 130, { maxWidth: 180 });
        
        doc.save(`laudo_CASO-001_${new Date().toISOString().split('T')[0]}.pdf`);
